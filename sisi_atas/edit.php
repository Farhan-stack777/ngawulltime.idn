...
<body>
            ...
            if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                ...
                if ($conn->query($sql) === TRUE) {
                    echo"<script>window.location='sisi_atas.php';</script>";
            ...
            $sql = "SELECT * FROM tb_sisi_atas WHERE id=$id";
                            ...
                            <div class="card">
                                ...
                                <form action="edit.php?id=<?php echo $id; ?>" method="post">
                                    <div class="form-group">
                                        <label for="link">Link wa:</label>
                                        <input type="text" id="link" name="link_wa" value="<?php echo htmlspecialchars($data['link_wa']); ?>" required />
                                    </div>
                                    
                                    <div class="form-group">
                                        <label for="link">Link ig:</label>
                                        <input type="text" id="link" name="link_ig" value="<?php echo htmlspecialchars($data['link_ig']); ?>" />
                                    </div>

                                    <div class="form-group">
                                        <label for="jam">Jam:</label>
                                        <textarea id="jam" name="jam"><?php echo htmlspecialchars($data['jam']); ?></textarea>
                                    </div>
