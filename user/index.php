...
<body class="layout-fixed sidebar-expand-lg sidebar-mini bg-body-tertiary"> <!--begin::App Wrapper-->
    <div class="app-wrapper"> <!--begin::Header-->
        ...
        <main class="app-main"> <!--begin::App Content Header-->
            ...
            <div class="header">
        <h1><center>PENGATURAN USER</center></h1>
            </div>
            ...
            $sql = "SELECT id_petugas, nama, telepon, password, email, alamat FROM tb_petugas";
                    ...
                    <?php if ($result->num_rows > 0): ?>
                        <?php while($row = $result->fetch_assoc()): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="hapus.php?id_petugas=<?php echo $row['id_petugas']; ?>" onclick="return confirm('Anda yakin ingin menghapus item ini?');">Hapus</a>
                                </td>
                            </tr>
                        <?php endwhile; ?>
                    <?php else: ?>
