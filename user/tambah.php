...
$con = mysqli_connect('localhost', 'root', '', 'bootcamp3');
    ...
    $query = mysqli_query($con, "SELECT * FROM tb_anggota WHERE nama='$data1'");
    ...
    if (mysqli_num_rows($query) > 0) {
        ...
        // Masukkan data baru
        $query = "INSERT INTO tb_anggota (id,nama,alamat,password,email,telepon) VALUES ('','$data1','$data2','$data3','$data4','$data5')";
