...
<body class="layout-fixed sidebar-expand-lg sidebar-mini bg-body-tertiary"> <!--begin::App Wrapper-->
    <div class="app-wrapper"> <!--begin::Header-->
        ...
        <main class="app-main"> <!--begin::App Content Header-->
            ...
            <div class="header">
        <h1><center>PENGATURAN T_SHIRT</center></h1>
            </div>
            ...
            $sql = "SELECT id, gambar, judul, harga, link FROM tb_tshirt";
            $result = $conn->query($sql);
            ?>
            <button type="button" class="btn btn-primary mb-2" onclick="window.location.href='form_tambah.php';">Tambah Data</button>
                        ...
                        <?php while($row = $result->fetch_assoc()): ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="hapus.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Anda yakin ingin menghapus item ini?');">Hapus</a>
