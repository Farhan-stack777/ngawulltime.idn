...
<body>
            ...
            if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                ...
                $sql = "UPDATE tb_tshirt SET judul='$judul', harga='$harga', link='$link' WHERE id=$id";
                
                if ($conn->query($sql) === TRUE) {
                    echo"<script>window.location='tshirt.php';</script>";
            ...
            $sql = "SELECT * FROM tb_tshirt WHERE id='$id' ";
