...
<body class="layout-fixed sidebar-expand-lg sidebar-mini bg-body-tertiary"> <!--begin::App Wrapper-->
    <div class="app-wrapper"> <!--begin::Header-->
        ...
        <main class="app-main"> <!--begin::App Content Header-->
            ...
            <div class="header">
        <h1><center>PENGATURAN PANTS</center></h1>
            </div>
            ...
            $sql = "SELECT id, gambar, judul, harga, link FROM tb_pants";
            $result = $conn->query($sql);
            ?>
            
                <a href="form_tambah1.php" class="btn-add">Tambah Data</a>
                        ...
                        <?php while($row = $result->fetch_assoc()): ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="hapus1.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Anda yakin ingin menghapus item ini?');">Hapus</a>
                                    <?php if (!$row["sold_out"]): ?>
                                        <a href="sold_out.php?id=<?php echo $row['id']; ?>&table=tb_pants">Mark as Sold Out</a>
                                    <?php endif; ?>
                                </td>
                            </tr>
                        <?php endwhile; ?>
