...
<body class="layout-fixed sidebar-expand-lg sidebar-mini bg-body-tertiary"> <!--begin::App Wrapper-->
    <div class="app-wrapper"> <!--begin::Header-->
        ...
        <main class="app-main"> <!--begin::App Content Header-->
            ...
            <div class="header">
                <h1><strong>FORM HOODIE AND SWEATHER</strong></h1>
            </div>
                    ...
                    <div class="row">
                        <div class="col-12"> <!-- Default box -->
                            ...
                            <div class="card">
                                ...
                                <form action="tambah2.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="title" name="title" placeholder="Masukkan judul di sini..." required />
                                    </div>
                                    
                                    <div class="form-group">
                                        <label for="date">Harga:</label>
                                        <input type="text" id="harga" name="harga" />
                                    </div>

                                    <div class="form-group">
                                        <label for="description">Link:</label>
                                        <textarea id="link" name="link" placeholder="Masukkan URL link di sini..."></textarea>
                                    </div>
