...
<body>
            ...
            if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                ...
                $sql = "UPDATE tb_sepatu SET judul='$judul', harga='$harga', link='$link' WHERE id=$id";
                
                if ($conn->query($sql) === TRUE) {
                    echo"<script>window.location='sepatu.php';</script>";
            ...
            $sql = "SELECT * FROM tb_sepatu WHERE id='$id' ";
                            ...
                            <div class="card">
                                ...
                                <form action="edit.php?id=<?php echo $id; ?>" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="harga" name="harga" value="<?php echo htmlspecialchars($data['harga']); ?>" />
                                    </div>

                                    <div class="form-group">
                                        <label for="deskripsi">Link:</label>
                                        <textarea id="link" name="link"><?php echo htmlspecialchars($data['link']); ?></textarea>
                                    </div>
