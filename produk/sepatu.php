...
<body class="layout-fixed sidebar-expand-lg sidebar-mini bg-body-tertiary"> <!--begin::App Wrapper-->
    <div class="app-wrapper"> <!--begin::Header-->
        ...
        <main class="app-main"> <!--begin::App Content Header-->
            ...
            <div class="header">
        <h1><center>PENGATURAN SEPATU</center></h1>
            </div>
            ...
            $sql = "SELECT id, gambar, judul, harga, link, sold_out FROM tb_sepatu";
                        ...
                        <?php while($row = $result->fetch_assoc()): ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php if (!$row["sold_out"]): ?>
                                        <a href="sold_out.php?id=<?php echo $row['id']; ?>&table=tb_sepatu">Mark as Sold Out</a>
                                    <?php endif; ?>
                                </td>
                            </tr>
                        <?php endwhile; ?>
