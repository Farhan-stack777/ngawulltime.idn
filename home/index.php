<?php
require_once "../config.php"; // Pastikan $con didefinisikan dengan benar di config.php
?>
<!DOCTYPE html>
<html>
<head>
...
<body class="layout-fixed sidebar-expand-lg sidebar-mini bg-body-tertiary"> <!--begin::App Wrapper-->
    <div class="app-wrapper"> <!--begin::Header-->
        ...
        <main class="app-main"> <!--begin::App Content Header-->
            ...
            <div class="header">
            <h1><strong>PENGATURAN HOME</strong></h1>
            </div>
                    ...
                    <div class="row">
                        <div class="col-12"> <!-- Default box -->
                            <br><div class="card">
                                ...
                                <?php
                            // Pastikan koneksi $con telah terhubung dengan benar di config.php
                            $sql = mysqli_query($con, "SELECT * FROM tb_home WHERE id='1'") or die(mysqli_error($con));
