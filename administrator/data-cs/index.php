          ...
          <div class="col-12">
            ...
            <div class="card card-primary">
              <div class="card-header" style="background-color: #<?php echo $warna1; ?>">
                <h3 class="card-title"><i class="fas fa-clipboard mr-2"></i>Data Customer Service</h3> 
              </div><!-- /.card-header -->
              <div class="card-body">
                <div class="button">                
                  ...
                  <table id="cobatabel" class="table table-sm table-bordered table-striped table-hover ">
                    <thead>
                      <tr>
                        ...
                        <th bgcolor="#ffffff" ><center>Nama</center></th>
                        <th bgcolor="#ffffff" ><center>Kontak</center></th>                        
                        <th bgcolor="#ffffff" ><center>Tingkat</center></th>                        
                        <th bgcolor="#ffffff" ><center>Status</center></th>
                      ...
                      if (mysqli_num_rows($sql_peran) >0 )
                      {
                        while($data = mysqli_fetch_array($sql_peran))
                        {
                          ...
                          <tr>
                            ...
                            <td>
                            <h6>
                                <a type="button" class="feedback"  target="_blank" href="https://api.whatsapp.com/send?phone=<?=$data['nama'];?>&text=Halo kak <?=$data['nama'];?>, dengan admin PT Pena Persada Kerta Utama ya? saya mau menerbitkan buku. Bagaimana detailnya. mohon infonya ya..."   name="chekout"><img src="../img/wa.png" style='width:20px; height:20px;'/> <?=$data['kontak'];?> </a> 
                              </h6>
                            </td>
                            <td align="center">
                              <h6>
                            ...
                            <td align="center">
                              <h6>
                                ...
                                if($data['status']==1)
                                {                                 
                                  echo"<span class='right badge badge-success'>Tampil</span>";
                                }
                                else
                                {
                                  echo"<span class='right badge badge-warning'>Sembunyikan</span>";
                                }
                                ?>
                              </h6>
                            </td>                            
                            <td >
                              <h6>
                                <center>
                                  ...
                                  data-id="<?=$data['id'];?>"
                                  data-layanan="<?=$data['nama'];?>"
                                  data-harga="<?=$data['kontak'];?>"
                  ...
                  <div class="card card-info">                
                    <div class="card-body" class="bootstrap-timepicker">
                      ...
                      <div class="form-group row">
                        <label class="col-sm-12 control-label">Nama Customer Service </label>
                        <div class="col-sm-12">
                          <input type="text" class="form-control" name="nama" id="layanan" placeholder="Nama " autofocus required>
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-12">
                          <input type="text" class="form-control" name="kontak" id="keterangan" placeholder="Contoh : 085600000000" required>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label class="col-sm-12 control-label">Status  </label>
                        <div class="col-sm-12">
                          <select class="custom-select rounded-0" id="exampleSelectBorder" name="status" required>
...
$('#modal-edit').on('show.bs.modal', function(e) {
    ...
    $(e.currentTarget).find('input[name="nama"]').val(layanan);
    $(e.currentTarget).find('input[name="kontak"]').val(harga);
    $(e.currentTarget).find('select[name="status"]').val(keterangan);
