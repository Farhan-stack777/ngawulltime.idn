          ...
          <div class="col-12">
            ...
            <div class="card card-primary">
              <div class="card-header" style="background-color: #<?php echo $warna1; ?>">
                <h3 class="card-title"><i class="fas fa-clipboard mr-2"></i>MENGAPA MEMILIH PENA PERSADA ?</h3> 
              </div><!-- /.card-header -->
              <div class="card-body">
                <div class="button"> 
                  ...
                  <table id="cobatabel" class="table table-sm table-bordered table-striped table-hover ">
                    <thead>
                      <tr>
                        ...
                        <th bgcolor="#ffffff" ><center>Judul</center></th>
                        <th bgcolor="#ffffff" ><center>Gambar</center></th>
                    ...
                    <tbody>
                      <?php
                      $no = 1;
                      $query = "SELECT * FROM tb_hal_penapersada WHERE Id!='1' ";
                      ...
                      if (mysqli_num_rows($sql_peran) >0 )
                      {
                        while($data = mysqli_fetch_array($sql_peran))
                        {
                          ...
                          <tr>
                            ...
                            <td align="right">
                              <h6>
                                <img src="gambar/<?=$data['gambar']; ?>" width="100px">
                              </h6>
                            </td>
                            <td>
                              <h6>
                            ...
                            <td >
                              <h6>
                                <center>
                                  <button type="button" class="btn btn-default btn-sm" style="background-color:#<?php echo $warna2; ?>;" data-toggle="modal" data-target="#modal-upload" data-id="<?=$data['Id']?>"><font color="white"><i class="fas fa-upload"></i></font>
                                  </button>  
                                  ...
                                  ><font color="white"><i class="fas fa-edit"></i></font>
                                  </button>
                  ...
                  <div class="card card-info">                
                    <div class="card-body" class="bootstrap-timepicker">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-12">
                          <input type="text" class="form-control" name="judul" id="judul" placeholder="Nama Layanan" autofocus required>
                        </div>
                      </div>                      
                      <div class="form-group row">                        
                        <label class="col-sm-12 control-label">Keterangan </label>
                        <div class="col-sm-12"> 
                          <textarea class="form-control" rows="4" name="keterangan" id="keterangan" placeholder="Keterangan ..." required></textarea>
                        </div>
                      </div>
                         <div class="form-group row">
                        <label for="inputEmail3" class="col-sm-12 control-label">Icon (513 x 513) </label>
                        <div class="col-sm-12">
...
<div class="modal fade" id="modal-upload" >
        <div class="modal-dialog modal-md">
          <div class="modal-content">
            <div class="modal-header" style="background-color:#<?php echo $warna2; ?>;">
              <h4 class="modal-title"><font color="#ffffff"><i class="fas fa-clipboard"></i> Upload Icon </font></h4>
            </div>
...
$('#modal-edit').on('show.bs.modal', function(e) {
    ...
    $(e.currentTarget).find('input[name="judul"]').val(judul);
