          ...
          <div class="col-12">
            ...
            <div class="card card-primary">
              <div class="card-header" style="background-color: #<?php echo $warna1; ?>">
                <h3 class="card-title"><i class="fas fa-clipboard mr-2"></i>Testimoni</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">                              
              ...
              <br>
             <?php
              $sql = "SELECT id, judul, deskripsi, judul1, deskripsi1, judul2, deskripsi2, judul3, deskripsi3 FROM tb_sisi_bawah";
            ...
            ?>
                ...
                <table id="cobatabel" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php
                    $no = 1;
                    $query = "SELECT * FROM tb_hal_testimoni ";                   
                      ...
                      <tr>
                        ...
                        <td>
                          <h6>
                            <center>
                            <?php if($data['foto']=="") { ?>
                              <img src="../img/male.png" width="100px">
                            <?php } else { ?>
                  ...
                  <div class="card card-info">                
                    <div class="card-body" class="bootstrap-timepicker">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-12">
                          <input type="text" class="form-control" name="asal" id="jabatan"  placeholder="asal" required> 
                        </div>
                      </div> 
                      <div class="form-group row">                        
                          <label class="col-sm-12 control-label">Testimoni </label>
                          <div class="col-sm-12"> 
                          <textarea class="form-control" rows="4" name="testimoni" id="testimoni" placeholder="Testimoni Pelanggan ..." required></textarea>
                        </div>
                      </div>
...
$('#modal-edit').on('show.bs.modal', function(e) {
    ...
    var asal     = $(e.relatedTarget).data('asal');    
    var testimoni        = $(e.relatedTarget).data('testimoni');

    $(e.currentTarget).find('input[name="id"]').val(id);    
    $(e.currentTarget).find('input[name="nama"]').val(nama);
    $(e.currentTarget).find('input[name="asal"]').val(asal);
    $(e.currentTarget).find('textarea[name="testimoni"]').val(testimoni);
