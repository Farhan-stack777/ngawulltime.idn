<?php
require_once "../config.php"; // Ensure $con is correctly defined in config.php
?>
<!DOCTYPE html>
<html lang="id">
<head>
...
<body class="layout-fixed sidebar-expand-lg sidebar-mini bg-body-tertiary"> <!--begin::App Wrapper-->
    <div class="app-wrapper"> <!--begin::Header-->
        ...
        <main class="app-main"> <!--begin::App Content Header-->
            ...
            <div class="header">
                <h1><strong>PENGATURAN LOGIN</strong></h1>
            </div>
                    ...
                    <div class="row">
                        <div class="col-12"> <!-- Default box -->
                            <br><div class="card">
                                ...
                                <?php
                                $sql = mysqli_query($con, "SELECT * FROM tb_pengaturan WHERE id='1'") or die(mysqli_error($con));
                                $data = mysqli_fetch_assoc($sql);
                                ?>
                                <div class="form-container">
                                    <form action="update.php" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label for="file">Gambar Login:</label>
                                            <img src="<?= "../berkas/" . htmlspecialchars($data['gambar']); ?>" alt="Gambar Login" height="100px">
                                            <input type="file" name="file" id="file">
                                        </div>

                                        <div class="form-group">
                                            <label for="nama_aplikasi">Nama Aplikasi:</label>
                                            <input type="text" name="nama_aplikasi" id="nama_aplikasi" value="<?= htmlspecialchars($data['nama_aplikasi']); ?>">
                                        </div>
