            ...
            <div class="row">
               <div class="col-md-5">
                  <div class="about_text">
                     <h3>Tentang Kita </h3>
                     <p>pada akhirnya ngawulltime.idn sekarang telah mempunyai banyak bagian seperti sepatu tas pants hodie sweater bahkan akan membuat kaos brand sendiri dengan nama part Hanss.cloid dan pelajaran yang bisa di ambil adalah merasa cukup terus kejarlah sesuatu yang membuatmu merasa bahagia pada usia muda ini perbanyaklah peluang bisnis dan pengalaman jangan hanya untuk bermain main yang tidak memberikan manfaat dan tabung lah untuk masa tua nanti dan juga untuk membahagiakan kedua orang tuamu. </p>
