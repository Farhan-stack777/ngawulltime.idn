...
<body>
            ...
            if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                ...
                $sql = "UPDATE tb_sisi_bawah SET judul='$judul', deskripsi='$deskripsi',judul1='$judul1', deskripsi1='$deskripsi1',judul2='$judul2', deskripsi2='$deskripsi2',judul3='$judul3', deskripsi3='$deskripsi3'  WHERE id=$id";
                
                if ($conn->query($sql) === TRUE) {
                    echo"<script>window.location='sisi_bawah.php';</script>";
            ...
            $sql = "SELECT * FROM tb_sisi_bawah WHERE id=$id";
...
<head>
    ...
    <style>
        ...
        .header {
            display: flex;
            align-items: center;
            justify-content: space-between; /* Membuat spasi antara elemen header */
            background-color: #f7e300; /* Warna kuning untuk header */
            padding: 10px;
        }
        .header h1 {
            flex: 1; /* Membuat judul mengambil ruang yang tersisa */
        ...
        .main-content {
            margin-left: 220px; /* Menyesuaikan margin dengan lebar sidebar */
            padding: 20px;
            background-color: #d9d9d9; /* Background color for the main content area */
            flex: 1;
            display: flex;
            align-items: center;
                            ...
                            <div class="card">
                                ...
                                <form action="edit.php?id=<?php echo $id; ?>" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="deskripsi" name="deskripsi" value="<?php echo htmlspecialchars($data['deskripsi']); ?>" />
                                    </div>

                                    <div class="form-group">
                                        <label for="jam">Judul 1</label>
                                        <textarea type="text" id="judul1" name="judul1"><?php echo htmlspecialchars($data['judul1']); ?></textarea>
                                    </div>

                                    <div class="form-group">
                                        <label for="link">Deskripsi 1</label>
                                        <input type="text" id="deskripsi1" name="deskripsi1" value="<?php echo htmlspecialchars($data['deskripsi1']); ?>" />
                                    </div>

                                    <div class="form-group">
                                        <label for="jam">Judul 2</label>
                                        <textarea type="text" id="judul2" name="judul2"><?php echo htmlspecialchars($data['judul2']); ?></textarea>
                                    </div>

                                    <div class="form-group">
                                        <label for="link">Deskripsi 2</label>
                                        <input type="text" id="deskripsi2" name="deskripsi2" value="<?php echo htmlspecialchars($data['deskripsi2']); ?>" />
                                    </div>

                                    <div class="form-group">
                                        <label for="jam">Judul 3</label>
                                        <textarea type="text" id="judul3" name="judul3"><?php echo htmlspecialchars($data['judul3']); ?></textarea>
                                    </div>

                                    <div class="form-group">
                                        <label for="link">Deskripsi 3</label>
                                        <input type="text" id="deskripsi3" name="deskripsi3" value="<?php echo htmlspecialchars($data['deskripsi3']); ?>" />
                                    </div>
